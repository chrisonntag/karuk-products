 ...
 */
class Karuk_Products_Metabox_Main {
	...
	public function __construct($pref) {
		...
		$this->fields = array(
			...
			array(
				'name' => __('Manufacturer Link', 'karuk-products'),
				'desc' => __('', 'karuk-products'),
			...
			array(
				'name' => __('Data Sheet Link', 'karuk-products'),
				'desc' => __('', 'karuk-products'),
				'id' => $prefix . 'datasheet',
				'type' => 'text',
				'std' => ''
	...
	public function add_meta_box( $post_type ) {
		...
		if ( in_array( $post_type, $post_types )) {
			add_meta_box(
				'products_meta_box_main'
				,__( 'Datasheet', 'karuk-products' )
	...
	public function save_product_information( $post_id ) {
		...
		if ( ! isset( $_POST['products_meta_box_main_nonce'] ) )
			return $post_id;

		$nonce = $_POST['products_meta_box_main_nonce'];

		// Verify that the nonce is valid.
		if ( ! wp_verify_nonce( $nonce, 'karuk_products_inner_meta_box_main' ) )
			return $post_id;
